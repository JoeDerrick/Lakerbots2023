...
import frc.robot.commands.SmartCommands.CollectPose;
import frc.robot.commands.SmartCommands.ScoreMiddleConePose;
...
private final XboxController xboxController1 = new XboxController(0);
  ...
  */
  ...
  private RobotContainer() {
   ...
   // m_wrist.setDefaultCommand(new WristJoystick( m_wrist )); //Xboxcontroller2 right Y
...
xboxButtonB.onTrue(new IntakeMotorGo( m_intake,0.05 ));

final JoystickButton xboxButtonA = new JoystickButton(xboxController1, XboxController.Button.kA.value);        
xboxButtonA.onTrue(new IntakeMotorGo( m_intake,-0.2));

final JoystickButton xboxButtonY = new JoystickButton(xboxController1, XboxController.Button.kY.value);        
xboxButtonY.onTrue(new ArmGoToPosition( m_arm,SetPoints.armPlaceConeMiddleFront ));

final JoystickButton xboxButtonX = new JoystickButton(xboxController1, XboxController.Button.kX.value);        
xboxButtonX.onTrue(new ArmGoToPosition( m_arm,SetPoints.armPickupFront ));

final JoystickButton xboxButtonLB = new JoystickButton(xboxController1, XboxController.Button.kLeftBumper.value);        
xboxButtonLB.onTrue(new CollectPose(m_elevator,m_intake, m_wrist, m_arm));

final JoystickButton xboxButtonRB = new JoystickButton(xboxController1, XboxController.Button.kRightBumper.value);        
xboxButtonRB.onTrue(new ScoreMiddleConePose(m_intake, m_wrist, m_arm,m_elevator));


 //------------------------OPERATOR CONTROLLER----------------------//

final JoystickButton xbox2ButtonX = new JoystickButton(xboxController2, XboxController.Button.kX.value);        
xbox2ButtonX.onTrue(new IntakeMotorGo(m_intake,0.2));

final JoystickButton xbox2ButtonY = new JoystickButton(xboxController2, XboxController.Button.kY.value);        
xbox2ButtonY.onTrue(new IntakeMotorGo(m_intake,-0.2));

final JoystickButton xbox2ButtonA = new JoystickButton(xboxController2, XboxController.Button.kA.value);        
xbox2ButtonA.onTrue(new IntakeMotorStop(m_intake));

final JoystickButton xbox2ButtonRB = new JoystickButton(xboxController2, XboxController.Button.kRightBumper.value);
xbox2ButtonRB.onTrue(new WristGoToPosition(m_wrist, SetPoints.WristScoreFront));

final JoystickButton xbox2ButtonLB = new JoystickButton(xboxController2, XboxController.Button.kLeftBumper.value);
xbox2ButtonLB.onTrue(new WristGoToPosition(m_wrist, SetPoints.WristCollect));

final JoystickButton xboxButton2Start = new JoystickButton(xboxController2,XboxController.Button.kStart.value);

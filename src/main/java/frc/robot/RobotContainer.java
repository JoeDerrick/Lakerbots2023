...
*/
    ...
    m_wrist.setDefaultCommand(new WristJoystick( m_wrist ));
...
xboxButtonB.onTrue(new ArmGoToPosition( m_arm,SetPoints.armPlaceConeHighFront ));

final JoystickButton xboxButtonA = new JoystickButton(xboxController1, XboxController.Button.kA.value);        
xboxButtonA.onTrue(new ArmGoToPosition( m_arm,SetPoints.armHome ));

...
public final class SetPoints {
    ...
    public static double armPlaceConeHighFront = 350;
    public static double armPlaceConeHighBack = -350;
    public static double armPlaceCubeHighFront = 300;
    ...
    public static double ElevatorMiddle = 100;
    public static double ElevatorTop = 200;

    //wrist setpoints
    public static double WristHome = 0;
    public static double WristTop = 100;
    public static double WristBack = -100;

...
public final class SetPoints {
    ...
    public static double armPickupUprightCone = -49;
    ...
    public static double WristChargeBack = 14;
    public static double WristPickupUprightCone = 11;
    public static double WristCollectBack = 22;

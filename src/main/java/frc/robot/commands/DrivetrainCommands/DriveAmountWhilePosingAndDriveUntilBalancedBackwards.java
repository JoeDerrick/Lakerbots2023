...
public class DriveAmountWhilePosingAndDriveUntilBalancedBackwards extends CommandBase {
    ...
    public DriveAmountWhilePosingAndDriveUntilBalancedBackwards(drivetrain m_Drivetrain, double speed, double amount){

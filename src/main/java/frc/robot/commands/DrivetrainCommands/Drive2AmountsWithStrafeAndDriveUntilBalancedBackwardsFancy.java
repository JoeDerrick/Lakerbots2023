...
public class Drive2AmountsWithStrafeAndDriveUntilBalancedBackwardsFancy extends CommandBase {
    ...
    public Drive2AmountsWithStrafeAndDriveUntilBalancedBackwardsFancy(drivetrain m_Drivetrain, double initialXspeed, double initialYspeed, double secondXspeed, double amount, double intermediateDistance){

...
public class CollectFloorPoseBackwithThreshold extends SequentialCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public CollectFloorPoseBackwithThreshold(elevator elevator,intake intake, wrist wrist,arm arm, leds leds){

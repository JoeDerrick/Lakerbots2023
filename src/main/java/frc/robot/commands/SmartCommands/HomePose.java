...
public class HomePose extends SequentialCommandGroup {
   // public intake intake;
    ...
    public HomePose(elevator elevator,intake intake, wrist wrist,arm arm){

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    addCommands(
    new ElevatorGoToPosition(elevator,SetPoints.ElevatorHome),
    new ArmGoToPosition(arm, SetPoints.armHome),
    new WristGoToPosition(wrist, SetPoints.WristHome),

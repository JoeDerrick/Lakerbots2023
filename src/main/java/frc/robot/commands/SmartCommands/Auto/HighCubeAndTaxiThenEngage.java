 ...
 *
 */
public class HighCubeAndTaxiThenEngage extends SequentialCommandGroup {

  

    public HighCubeAndTaxiThenEngage(intake intake, wrist wrist, arm arm, elevator elevator, drivetrain drivetrain, leds leds){

...
public class WristArmParallel extends ParallelCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public WristArmParallel(wrist wrist,arm arm, double wristPoint, double armPoint){

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    addCommands(
    new WristGoToPosition(wrist, wristPoint),
    new ArmGoToPosition(arm, armPoint)

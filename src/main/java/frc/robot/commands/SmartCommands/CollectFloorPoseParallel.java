...
public class CollectFloorPoseParallel extends ParallelCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public CollectFloorPoseParallel(elevator elevator,intake intake, wrist wrist,arm arm, leds leds){

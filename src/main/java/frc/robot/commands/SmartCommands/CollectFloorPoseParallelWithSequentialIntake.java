...
public class CollectFloorPoseParallelWithSequentialIntake extends SequentialCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public CollectFloorPoseParallelWithSequentialIntake(elevator elevator,intake intake, wrist wrist,arm arm, leds leds){

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    addCommands(
    new CollectFloorPoseParallel(elevator, intake, wrist, arm, leds),

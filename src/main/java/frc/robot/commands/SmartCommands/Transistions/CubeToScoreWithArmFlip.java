...
public class CubeToScoreWithArmFlip extends ParallelCommandGroup {
   // public intake intake;

    

    public CubeToScoreWithArmFlip(double amount,double xSpeed, double ySpeed,intake intake,drivetrain drivetrain, wrist wrist,arm arm,elevator elevator){

    
    addCommands(
    new HomePose(elevator, intake, wrist, arm),
    new DriveAmountWhileCollecting(intake, drivetrain,amount,xSpeed,ySpeed,0.08, true)//x = forward, y = strafe
    );
    }

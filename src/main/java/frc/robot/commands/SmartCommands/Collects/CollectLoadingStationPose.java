...
public class CollectLoadingStationPose extends SequentialCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public CollectLoadingStationPose(elevator elevator,intake intake, wrist wrist,arm arm){

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    addCommands(
    new ArmGoToPosition(arm, SetPoints.armLoadingStation),   
    new ElevatorGoToPosition(elevator,SetPoints.ElevatorLoadingStation),
    new WristGoToPosition(wrist, SetPoints.WristLoadingStation),

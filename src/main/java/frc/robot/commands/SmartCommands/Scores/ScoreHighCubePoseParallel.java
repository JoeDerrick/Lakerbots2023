...
public class ScoreHighCubePoseParallel extends SequentialCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public ScoreHighCubePoseParallel(intake intake, wrist wrist,arm arm,elevator elevator){

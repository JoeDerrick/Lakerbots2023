...
import frc.robot.commands.ArmCommands.ArmGoToPositionInstant;
...
public class ScoreMiddleConePose extends SequentialCommandGroup {
   // public intake intake;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    public ScoreMiddleConePose(intake intake, wrist wrist,arm arm,elevator elevator){

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    addCommands(
    new ArmGoToPositionInstant(arm, SetPoints.armPlaceConeMiddleFront),
